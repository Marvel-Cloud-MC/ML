...
bot.add_handler(MessageHandler(mirror, filters=command(BotCommands.MirrorCommand))
bot.add_handler(MessageHandler(unzip_mirror, filters=command(BotCommands.UnzipMirrorCommand))
bot.add_handler(MessageHandler(zip_mirror, filters=command(BotCommands.ZipMirrorCommand))
bot.add_handler(MessageHandler(qb_mirror, filters=command(BotCommands.QbMirrorCommand))
bot.add_handler(MessageHandler(qb_unzip_mirror, filters=command(BotCommands.QbUnzipMirrorCommand))
bot.add_handler(MessageHandler(qb_zip_mirror, filters=command(BotCommands.QbZipMirrorCommand))
bot.add_handler(MessageHandler(leech, filters=command(BotCommands.LeechCommand))
bot.add_handler(MessageHandler(unzip_leech, filters=command(BotCommands.UnzipLeechCommand))
bot.add_handler(MessageHandler(zip_leech, filters=command(BotCommands.ZipLeechCommand))
bot.add_handler(MessageHandler(qb_leech, filters=command(BotCommands.QbLeechCommand))
bot.add_handler(MessageHandler(qb_unzip_leech, filters=command(BotCommands.QbUnzipLeechCommand))
bot.add_handler(MessageHandler(qb_zip_leech, filters=command(BotCommands.QbZipLeechCommand))
bot.add_handler(MessageHandler(cloneNode, filters=command(BotCommands.CloneCommand))
